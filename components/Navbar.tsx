...
export default function Navbar({ user }: NavbarProps) {
  ...
  return (
    <header
      className={`bg-white/95 border-b border-zinc-200 text-zinc-900 dark:bg-zinc-950/95 dark:border-zinc-800 dark:text-zinc-100 sticky top-0 z-50 transition-shadow ${
