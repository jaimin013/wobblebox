    ...
    <div className="mb-8">
      <h2 className="text-4xl font-bold text-default-900">
        ...
        <span className="text-primary">
          {userName?.length > 10
          ? `${userName?.substring(0,10)}...` : userName?.split(" ")[0] || "there"}
        </span>
        ! 
      </h2>
      ...
      >
        ...
        >
          <div className="lg: col-span-1">
            <Card
            className="border border-default-200 bg-default-50 shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardBody>
                <FileUploadForm
                userId={userId}
                onUploadSucess={handleFileUploadSuccess}
